...
class PowerOcean(BaseDevice):
    ...
    def sensors(self, client: EcoflowApiClient) -> list[SensorEntity]:
        sensors: list[SensorEntity] = [
            ...
            WattsSensorEntity(client, self, "96_1.bpPwr", "bpPwr"),
            WattsSensorEntity(client, self, "96_1.mpptPwr", "mpptPwr"),
            WattsSensorEntity(client, self, "96_1.sysGridPwr", "sysGridPwr"),
